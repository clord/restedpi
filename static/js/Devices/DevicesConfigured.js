...
function ActionCol({cell}) {
    ...
    return [
        h("button", {className: 'text-sm text-gray-500 py-1 px-3', onClick: handleRemove}, "Remove"),
        h("button", {className: 'text-sm bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-3 rounded', onClick: handleEdit}, "Edit"),
    ]
}
...
function AddDevice({cell}) {
    ...
    return h("a", {className: 'bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded', href:"/devices/available"}, "Add Device")
}
...
export function DevicesConfigured() {
    ...
    return h('article', {className: "max-w-sm w-full lg:max-w-full"}, [
        h("div", {className: "flex mb-4 justify-between items-baseline"},[
            h("h1", {className: "text-gray-900 font-bold text-xl mb-3"}, "Configured Devices"),
            h(AddDevice, {})
        ]),
