import {c as createCommonjsModule,u as unwrapExports}from'./_commonjsHelpers-62a4d7f9.js';import {c as checkPropTypes}from'./checkPropTypes-9f1f0edf.js';import {a as react_development}from'./react.development-0624802a.js';var react = createCommonjsModule(function (module) {
...
{(function(){var React=react;var _assign=Object.assign;var Scheduler=scheduler;var checkPropTypes$1=checkPropTypes;var tracing$1=tracing;// Do not require this module directly! Use normal `invariant` calls with
...
{unmountHostComponents(finishedRoot,current$$1,renderPriorityLevel);}return;}case FundamentalComponent:{return;}case DehydratedFragment:{return;}case ScopeComponent:}}function commitNestedUnmounts(finishedRoot,root,renderPriorityLevel){// While we're inside a removed host node we don't want to call
